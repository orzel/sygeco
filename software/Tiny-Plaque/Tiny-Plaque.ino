...
NEW_GAME:;
    ...
    while (1) {
        ...
        switch (GD.Skip_Frame) {
            case 0:ATTAQUE1_TPLAQUE=!ATTAQUE1_TPLAQUE; Tiny_Flip_TPLAQUE(0); break;
...
void Tiny_Flip_TPLAQUE(uint8_t T_FLIP)
{
    ...
    for (y = A; y < B; y++) {
        ...
        for (x = 0; x < 128; x++) {
            ...
            switch (T_FLIP) {
                case 0: SSD1306.ssd1306_send_byte(Recupe_TPLAQUE(x,y)); break;
                case 1: SSD1306.ssd1306_send_byte(Recupe_DCOUNT_TPLAQUE(x,y)|recupe_SCORES_TPLAQUE(x,y)|Recupe_ExtraTeeth_TPLAQUE(x,y)); break;
                case 2: SSD1306.ssd1306_send_byte(TRACE_TPLAQUE(x)|recupe_SCORES_TPLAQUE(x,y)|Recupe_ExtraTeeth_TPLAQUE(x,y)); break;
                case 3: SSD1306.ssd1306_send_byte(recupe_SCORES_TPLAQUE(x,y)|INTRO_TPLAQUE(x,y)|BACK_TPLAQUE(x,y)); break;
                default:break;
            }
        }
